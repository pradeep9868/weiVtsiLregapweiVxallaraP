...
/**
 * Created by Pradeep on 12/26/2015.
 */
...
public class PagerSlidingStripPoints extends HorizontalScrollView {
    ...
    public PagerSlidingStripPoints(Context context) {

        this(context, null);
    }

    public PagerSlidingStripPoints(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PagerSlidingStripPoints(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int add_sub = (int)(lineRight-lineLeft-100)/2;

        canvas.drawRect(lineLeft+add_sub, height - indicatorHeight, lineRight-add_sub, height, rectPaint);
    ...
    public void select(int position)
    {
        for(int i=0;i<tv.size();i++)
        {
            ...
            {
                tv.get(i).setTextColor(Color.parseColor("#aaaaaa"));
            }
        }
    }
